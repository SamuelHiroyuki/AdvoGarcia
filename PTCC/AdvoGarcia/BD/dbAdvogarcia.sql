...
create table tbCaso(
	...
	ID_Cli int foreign key references tbCliente(ID_Cli) not null,
...
create table tbMensagem(
	...
	Status_Msg bit not null,
	Texto_Msg nvarchar(1000) not null,
	ID_Cli int foreign key references tbCliente(ID_Cli) not null,
	ID_Advogado int foreign key references tbAdvogado(ID_Advogado)
);
go
...
insert into tbCliente(Nome_Cli, End_Cli, Email_Cli, Foto_Cli, User_Cli, Pass_Cli, CPF_Cli, Tel_Cli,
 FormaPaga)
values('Cliente C2', 'PraçaC2', 'emailC2', 'c:2', 'cli', '123', '12345678901', '11543211234', 'Cheque')
go

insert into tbCaso(Descricao_Caso, Status_Caso, ID_Cli)
values('Um pão', 'Andamento', 1)
go

insert into tbCaso(Descricao_Caso, Status_Caso, ID_Cli, ID_Advogado)
values('Caso 2', 'Andamento', 1, 1)
go

insert into tbMensagem(Status_Msg, Texto_Msg, ID_Cli, ID_Advogado)
values(1, 'Teste', 1, 1)
go
