...
namespace Teste_CMD_copy
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Digite o nome de um arquivo para copiar: ");
            ...
            Console.WriteLine("Digite o nome de um arquivo para deletar: ");
            string nome = Console.ReadLine();
            if (System.IO.File.Exists(@"C:\Users\samhi\Desktop\Trabalho H\AdvoGarcia\Fotos\" + nome+".jpg"))
            {
                System.IO.File.Delete(@"C:\Users\samhi\Desktop\Trabalho H\AdvoGarcia\Fotos\" + nome+".jpg");
            }
        }
    }
}
